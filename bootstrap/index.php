    ...
    <div class="col-sm-8 text-left"> 
		 <?php
			...
			while ($r = $recordset->fetch_object()) {
				...
				$author = $r->author;
				$publishDate = strtotime($r->publishDate);
				$content = $r->content;
					echo '<h3 style="color:blue;">' . ucwords($title) . '</h3><br>';
					echo '<p style="font-style: italic;color: #535362;	font-size: 85%;">' . $author . '</p>';
					echo '<p style="font-style: italic;color: #535362;	font-size: 85%;">' . date("F j, Y ", $publishDate) . '</p><br>';
					echo '<div id="expandable" >';
						echo '<div class="text toggle" style="text-align: justify;">' . $content . '<br></div><br>';
