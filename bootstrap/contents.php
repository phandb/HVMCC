...
<head>
 <meta charset="utf-8">
  ...
  <title>Holy Vietnamese Martyrs Catholic Church</title>
  ...
  <!--------------left column---------->  
    <div class="col-sm-2 sidenav">
		...
		<article >
			...
			<p><u>Saturday</u><br/>6:30 p.m.<br/></p>
			<p><u>Sunday</u><br/>
				8:00 a.m.<br/>
				11:30 a.m. <span style = "font-size:90%">(10:30 a.m. During Summer)</span><br/></p>
    ...
    <div class="col-sm-8 text-left"> 
		 <?php
			...
			/*isset() is used to check article id recived through url from the index.php*/
			
			if(isset($_GET['id'])){
				$id=$_GET['id'];
				$sql = "SELECT title, author, DATE_FORMAT(publishDate,m-d-Y), content FROM article WHERE id=$id";
				$recordset = $dbConn->query($sql) or die('Error perform query!');
				if(!$recordset){
					die('Could not get data!' . mysql_error());
				}
			}
			while ($r = $recordset->fetch_object()) {
					echo '<h3 style="color:blue;">' . $r->title . '</h3><br>';
					echo '<p style="font-style: italic;color: #535362;	font-size: 85%;">' . $r->author . '</p>';
					echo '<p style="font-style: italic;color: #535362;	font-size: 85%;">' . $r->publishDate . '</p><br>';
					echo '<div id="expandable" >';
						echo '<div class="text showmore-height" style="text-align: justify;">' . $r->content . '<br></div><br>';
						echo '<div class = "showmore">(More...)</div>';
						echo '<hr>';
					echo '</div>';	
...
<footer class=" col-sm-12 container-fluid text-center">
  <p>Holy Vietnamese Martyrs Catholic Church<br/>
				1107 E. Yager Lane- Austin Texas 78753 - Rectory: (512)-834-8483, Offices: (512)-491-7259 
				Fax: (512)-821-1155</p>
</footer>
</div>
